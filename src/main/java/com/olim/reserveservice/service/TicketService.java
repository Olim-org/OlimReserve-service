...
public interface TicketService {
    ...
    @Transactional
    TicketGetListResonse getTicketList(UUID userId, UUID centerId, int page, int count, String sortBy, String keyword, Boolean orderByDesc, String type, String status);
    @Transactional
